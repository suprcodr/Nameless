...
using Nameless.Framework.EventSourcing.Snapshots;
using Nameless.Framework.IoC;

namespace Nameless.Framework.EventSourcing.IoC {

    /// <summary>
    /// Autofac module implementation for Nameless.Framework.EventStore assembly.
    /// </summary>
