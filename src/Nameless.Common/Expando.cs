...
namespace Nameless {
    ...
    public class Expando : DynamicObject, IDynamicMetaObjectProvider {
        ...
        public object this[string key] {
            get {
                try { return Properties[key]; /* try to get from properties collection first */ }
            ...
            set {
                ...
                if (!array.IsNullOrEmpty()) { SetProperty(_instance, key, value); }
        ...
        public override bool TryGetMember(GetMemberBinder binder, out object result) {
            ...
            if (_instance != null) {
                try { return GetProperty(_instance, binder.Name, out result); }
                catch { }
            }
