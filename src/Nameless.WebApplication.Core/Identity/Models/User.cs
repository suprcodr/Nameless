...
#pragma warning restore 0649
        ...
        public bool Equals(User obj) {
            return obj != null &&
                   string.Equals(obj.UserName, UserName, StringComparison.CurrentCultureIgnoreCase) &&
                   string.Equals(obj.Email, Email, StringComparison.CurrentCultureIgnoreCase) &&
        ...
        public override int GetHashCode() {
            var hash = 13;
            unchecked {
                hash += (UserName ?? string.Empty).GetHashCode() * 7;
                hash += (Email ?? string.Empty).GetHashCode() * 7;
