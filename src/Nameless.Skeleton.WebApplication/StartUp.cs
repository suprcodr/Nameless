...
using Nameless.Skeleton.Framework.Web.Identity.Stores;
using Nameless.Skeleton.WebApplication.Code;
    ...
    public class StartUp {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services) {
            ...
            var supportAssemblies = new[] {
                Assembly.Load(new AssemblyName("Nameless.Skeleton.Common")),
                Assembly.Load(new AssemblyName("Nameless.Skeleton.Framework")),
                Assembly.Load(new AssemblyName("Nameless.Skeleton.Framework.Impl")),
                Assembly.Load(new AssemblyName("Nameless.Skeleton.Framework.Web")),
                Assembly.Load(new AssemblyName("Nameless.Skeleton.WebApplication"))
            };
