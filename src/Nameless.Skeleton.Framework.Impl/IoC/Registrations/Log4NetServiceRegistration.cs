...
using Nameless.Skeleton.Framework.Logging.Impl;

namespace Nameless.Skeleton.Framework.IoC.Modules {

    /// <summary>
    /// Autofac module for implementations from Nameless.Skeleton.Framework.Logging namespace.
    /// </summary>
    public sealed class Log4NetServiceRegistration : ServiceRegistrationBase {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Log4NetServiceRegistration"/>
        /// </summary>
        public Log4NetServiceRegistration()
            : base(null) { }
        ...
        public Log4NetServiceRegistration(IEnumerable<Assembly> supportAssemblies)
        ...
        public override void Register() {
            Builder.RegisterType(GetLoggerFactoryImplementation()).OnRegistered(AttachToComponentRegistration).As<ILoggerFactory>().SetLifetimeScope(LoggerFactoryLifetimeScope);
            Builder.Register(CreateLogger).As<ILogger>().SetLifetimeScope(LoggerLifetimeScope);
        }
